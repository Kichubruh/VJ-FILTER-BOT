...
API_ID = int(environ.get('API_ID', '29114797'))
API_HASH = environ.get('API_HASH', 'a4d6a2c1febd7e253d706596d93351bf')
BOT_TOKEN = environ.get('BOT_TOKEN', "7430409423:AAEVczVLbEq790POXvdwJs52wiqPnVljqhY")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002274165422'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5117706544').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002364938386').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nsbland45:nsbnsb123456@cluster0.k24v9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_bot_disscussi')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/flamiee')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscu') # Support Chat Link Without https:// or @
